...
[![skills.sh](https://skills.sh/b/siesdart/skills)](https://skills.sh/siesdart/skills)
...
| [`typescript-functional-patterns`](skills/typescript-functional-patterns/SKILL.md)                       | Applies Remeda, neverthrow, and ts-pattern as a coherent TypeScript transformation, error, and exhaustive-branching style. | Select automatically for TypeScript work                     |
